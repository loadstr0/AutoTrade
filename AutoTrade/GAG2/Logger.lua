-- AutoTrade/GAG2/Logger.lua
--
-- Verbatim copy of AutoTrade/BB/Logger.lua -- this module has zero
-- Blade-Ball-specific logic (pure string formatting + result-file
-- writing), so it's reused unchanged rather than duplicated with drift
-- risk. If you ever fix a bug here, fix it in both copies.
