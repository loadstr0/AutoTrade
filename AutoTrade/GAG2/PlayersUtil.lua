-- AutoTrade/GAG2/PlayersUtil.lua
--
-- Verbatim copy of AutoTrade/BB/PlayersUtil.lua -- pure Players-service
-- lookup helpers, nothing Blade-Ball-specific. Reused unchanged.
